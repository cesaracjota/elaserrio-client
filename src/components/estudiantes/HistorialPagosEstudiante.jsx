...
import { getPagoByStudent, reset } from '../../features/pagos/pagoSlice';
...
const HisotorialPagoEstudiantes = ({ location }) => {
    ...
    const { pagos_by_student, isLoading, isError, message, currentPage, totalRows } = useSelector((state) => state.pagos);
